...
if user_menu == 'Overall Analysis':
     ...
     st.title("Athlete Participating over the years")
     st.plotly_chart(fig)

     st.title("No. of Events Held Over(Every Sport)")
...
if user_menu == 'Country-wise Analysis':
    ...
    st.title(selected_country + " excel in the following")
...
if user_menu == 'Athlete-wise Analysis':
   ...
   st.title("Distribution according to the Age")
