...
def men_vs_women(df):
    athlete_df = df.drop_duplicates(subset =['Name','region'])
    men = athlete_df[athlete_df["Sex"] == "M"].groupby("Year").count()['Name'].reset_index().astype('int')
    women = athlete_df[athlete_df["Sex"] == "F"].groupby("Year").count()['Name'].reset_index().astype('int')
